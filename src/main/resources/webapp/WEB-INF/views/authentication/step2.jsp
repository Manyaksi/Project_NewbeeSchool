...
<div clas="contatiner" style="margin-top: 80px;  margin-left:120px; margin-right:120px;">
...
<div class="col-md-12">
            <div class="row">
            <h1>프로그래밍을 처음 시작 하시나요?</h1>
            
            <a href="/registeration3" class="btn">네</a>
            <a href="/registeration3" class="btn">아니오</a>
                </div>
            
            <div class="space30"></div>
            
            
            <div class="text-center"> <a href="/registeration1" class="btn">이전</a>
            <a href="/registeration3" class="btn">다음</a></div>
